...
class EmployeesHomePage(tk.Frame) :
    def __init__(self, frame, master) :
        # Initialize Frame.
        tk.Frame.__init__(self, frame)

        master.title('Employees Information')
        ...
        # Create Labels.
        self.new_employees_label = tk.Label(self.new_records_frame, text = 'New Employees Information',
        ...
        # Position Labels.
        self.new_employees_label.grid(row = 0, column = 0, padx = 5, pady = (0, 5))
        ...
        self.monthly_wage = tk.Spinbox(self.new_records_frame, values = tuple(range(2400, 1000250, 250)),
            bg = self.general_entry_bg, fg = 'black', font = self.general_entry_font, borderwidth = 2)
        ...
        self.job_title.insert(0, 'Your Title')

        self.addRecordButton = tk.Button(self.new_records_frame, text = 'Add Employee', bg = self.button_bg, fg = 'white',
        ...
        self.deleteRecordbutton = tk.Button(self.existing_records_frame, text = 'Delete Employee', bg = self.button_bg, fg = 'white',
...
class EmployeesEditWindow(tk.Toplevel) :
    def __init__(self, home_page) :
        ...
        # Create Labels.
        self.edit_record_label = tk.Label(self.edit_frame, text = 'New Employees Information',
            bg = self.general_label_bg, fg = 'black', font = self.general_label_font, borderwidth = 2, anchor = tk.E)
        ...
        # Create Text Entry Widgets.
        self.first_name = tk.Entry(self.edit_frame, bg = self.general_entry_bg, fg = 'black',
            font = self.general_entry_font, borderwidth = 2)
        self.last_name = tk.Entry(self.edit_frame, bg = self.general_entry_bg, fg = 'black',
            font = self.general_entry_font, borderwidth = 2)
        self.email_address = tk.Entry(self.edit_frame, bg = self.general_entry_bg, fg = 'black',
            font = self.general_entry_font, borderwidth = 2)
        self.phone_number = tk.Entry(self.edit_frame, bg = self.general_entry_bg, fg = 'black',
            font = self.general_entry_font, borderwidth = 2)
        ...
        self.department = tk.Spinbox(self.edit_frame, values = self.department_options,
            bg = self.general_entry_bg, fg = 'black', font = self.general_entry_font, borderwidth = 2)
        self.monthly_wage = tk.Spinbox(self.edit_frame, values = tuple(range(2400, 1000250, 250)),
            bg = self.general_entry_bg, fg = 'black', font = self.general_entry_font, borderwidth = 2)
...
class EmployeesRecordsWindow(tk.Toplevel) :
    def __init__(self, home_page) :

        # Can Initialize GUI Implicitly.
        super().__init__()

        self.title('Employees Information')
        self.iconbitmap('Images/Icons/Database_Icon.ico')
        ...
        self.records_data_label = tk.Label(self.db_records_frame, text = 'Employees Data',
